...
var file_api_v1_log_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x22, 0x32, 0x0a, 0x0f, 0x43, 0x6f, 0x6e, 0x73, 0x75, 0x6d, 0x65, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1f, 0x0a, 0x06, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x07, 0x2e, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x52, 0x06,
	0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x32, 0xd7, 0x01, 0x0a, 0x03, 0x4c, 0x6f, 0x67, 0x12, 0x2e,
...
var file_api_v1_log_proto_depIdxs = []int32{
	...
	0, // 1: ConsumeResponse.record:type_name -> Record
	1, // 2: Log.Produce:input_type -> ProduceRequest
	3, // 3: Log.Consume:input_type -> ConsumeRequest
	3, // 4: Log.ConsumeStream:input_type -> ConsumeRequest
	1, // 5: Log.ProduceStream:input_type -> ProduceRequest
	2, // 6: Log.Produce:output_type -> ProduceResponse
	4, // 7: Log.Consume:output_type -> ConsumeResponse
	4, // 8: Log.ConsumeStream:output_type -> ConsumeResponse
	2, // 9: Log.ProduceStream:output_type -> ProduceResponse
